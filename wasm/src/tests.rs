...
fn test_run_error_program_multiple_shots() {
    ...
    .expect("code should compile and run");
    expect![[r#"
        {"result":[{"diagnostic":{"code":"Qsc.Eval.QubitUniqueness","message":"runtime error: qubits in invocation are not unique","range":{"end":{"character":53,"line":112},"start":{"character":36,"line":112}},"severity":"error"},"document":"qsharp-library-source:intrinsic.qs","stack":"Error: qubits in invocation are not unique\nCall stack:\n    at QIR.Intrinsic.__quantum__qis__cx__body in qsharp-library-source:qir.qs\n    at Microsoft.Quantum.Intrinsic.CNOT in qsharp-library-source:intrinsic.qs\n    at Test.Main in test.qs\n"}],"success":false,"type":"Result"}
        {"result":[{"diagnostic":{"code":"Qsc.Eval.QubitUniqueness","message":"runtime error: qubits in invocation are not unique","range":{"end":{"character":53,"line":112},"start":{"character":36,"line":112}},"severity":"error"},"document":"qsharp-library-source:intrinsic.qs","stack":"Error: qubits in invocation are not unique\nCall stack:\n    at QIR.Intrinsic.__quantum__qis__cx__body in qsharp-library-source:qir.qs\n    at Microsoft.Quantum.Intrinsic.CNOT in qsharp-library-source:intrinsic.qs\n    at Test.Main in test.qs\n"}],"success":false,"type":"Result"}
        {"result":[{"diagnostic":{"code":"Qsc.Eval.QubitUniqueness","message":"runtime error: qubits in invocation are not unique","range":{"end":{"character":53,"line":112},"start":{"character":36,"line":112}},"severity":"error"},"document":"qsharp-library-source:intrinsic.qs","stack":"Error: qubits in invocation are not unique\nCall stack:\n    at QIR.Intrinsic.__quantum__qis__cx__body in qsharp-library-source:qir.qs\n    at Microsoft.Quantum.Intrinsic.CNOT in qsharp-library-source:intrinsic.qs\n    at Test.Main in test.qs\n"}],"success":false,"type":"Result"}"#]]
    .assert_eq(&output.join("\n"));
}
